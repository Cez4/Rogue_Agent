...
static func get_attack_range(actor: Node) -> float:
...
static func get_attack_stop_distance(actor: Node) -> float:
...
static func get_perception_min_distance(actor: Node) -> float:
	return maxf(0.0, actor.get_stat_value(&"perception_min_distance", actor.base_perception_min_distance))


static func get_perception_max_distance(actor: Node) -> float:
...
static func get_combat_acquire_radius(actor: Node) -> float:
...
static func get_combat_lose_radius(actor: Node) -> float:
...
static func get_combat_target_memory_sec(actor: Node) -> float:
...
static func get_combat_reacquire_interval_sec(actor: Node) -> float:
