...
2. `plano-sprint-saveflow-slots-host-authority-v1-2026-05-13.md` (proxima sprint planejada: slots e autoridade SaveFlow)
3. `status-freeze-operacional-v15-saveflow-lite-prep-2026-05-13.md` (freeze operacional: SaveFlow Lite instalado e planejamento congelado)
4. `status-freeze-funcional-v14-dynamic-loot-dex-2026-05-13.md` (freeze funcional: Dynamic Loot & DEX System aprovado)
5. `plano-sprint-saveflow-lite-persistence-v1-2026-05-13.md` (sprint concluida: persistencia local/host-authoritative com SaveFlow Lite)
6. `plano-sprint-kite-distance-finetuning-v14-2-2026-05-13.md` (micro-freeze V14.2 de kite distance)
7. `plano-sprint-balance-scale-v14-1-2026-05-13.md` (micro-freeze V14.1 de escala HP/dano)
8. `plano-sprint-dynamic-loot-dex-v1-2026-05-13.md` (sprint concluida e congelada em V14)
9. `status-freeze-funcional-v13-inventory-datadriven-core-2026-05-13.md` (freeze: Inventory Data-Driven Core aprovado)
10. `plano-sprint-inventory-datadriven-core-v1-2026-05-13.md` (sprint concluida e congelada em V13)
11. `status-freeze-funcional-v12-inventory-expresso-spike-2026-05-13.md` (freeze: Inventory ExpressoBits Spike aprovado)
12. `plano-sprint-inventory-expresso-spike-v1-2026-05-13.md` (sprint concluida e congelada em V12)
13. `status-freeze-funcional-v11-hitbreak-combat-feedback-2026-05-13.md` (freeze historico: Hitbreak Combat Feedback aprovado)
14. `plano-sprint-hitbreak-combat-feedback-v1-2026-05-13.md` (sprint concluida e congelada em V11)
15. `status-freeze-operacional-v10-combat-core-restored-2026-05-13.md` (Combat Core restaurado, Combat Clash temporal removido)
16. `status-freeze-funcional-v9-hostile-hit-reaction-2026-05-12.md` (Hostile Hit Reaction Coverage aprovado)
17. `plano-sprint-combat-clash-parry-v1-2026-05-12.md` (Combat Clash temporal auditado e removido do runtime)
18. `status-freeze-funcional-v8-wildcat-hit-reaction-2026-05-12.md` (Wildcat Hit Reaction aprovado)
19. `plano-sprint-wildcat-hit-reaction-v1-2026-05-12.md` (Wildcat + hostis concluidos)
20. `status-freeze-funcional-v7-hit-reaction-2026-05-12.md` (Player Hit Reaction/Hit Stun universal aprovado)
21. `plano-sprint-universal-hit-reaction-component-v1-2026-05-12.md` (sprint concluida)
22. `status-freeze-funcional-v6-knockback-2026-05-12.md` (knockback modular/Data-Driven com baseline `200.0`)
23. `plano-sprint-combat-knockback-component-v1-2026-05-12.md` (sprint concluida)
24. `status-freeze-funcional-v5-actor-profiles-2026-05-12.md` (actor profiles concluido)
25. `status-freeze-total-combate-tatico-2026-05-11.md` (freeze total aprovado historico)
26. `recomendacoes-techlead-pos-freeze-2026-05-11.md` (proximos passos recomendados)
27. `plano-sprint-health-regen-datadriven-v1-2026-05-11.md` (freeze concluido)
28. `plano-sprint-actor8dir-facade-slimming-v1-2026-05-11.md` (fechamento parcial congelado)
29. `plano-sprint-actor-export-profile-organization-v1-2026-05-11.md` (sprint concluida ate E3; ver V5)
30. `plano-sprint-kiting-datadriven-v1-2026-05-11.md` (sprint concluida)
31. `status-freeze-funcional-v3-limbo-modular-2026-05-11.md` (arquitetura modular LimboAI)
...
1. Quando houver conflito entre docs antigos e estado atual:
   ...
   - o plano SaveFlow Slots & Host Authority v1 e a proxima sprint planejada para expor save/load jogavel por autoridade Nexus;
