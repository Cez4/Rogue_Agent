...
16. Telemetria BT (v2 - social/wander):
- tasks sociais instrumentadas com o mesmo padrao `task/status/reason`:
  - `bt_acquire_target_in_group`
  - `bt_is_target_in_range`
  - `bt_look_at_target`
  - `bt_idle_wander_loop`
- mantido modelo debug-gated para evitar ruido em producao.
